        ...
        <div>
          ...
          <div class="mt-4 space-y-2">
            <div v-for="(file, index) in uploadedFiles" :key="index" 
                 class="group flex items-center justify-between p-3 hover:bg-[#FAFAFA] dark:hover:bg-[#E2E8F0] rounded-lg transition-all duration-200">
              ...
              <div class="flex items-center space-x-4">
                ...
                <div v-if="file.status === 'uploading'"
                  ...
                  <div v-if="!hoverStates[index]" class="absolute inset-0 flex items-center justify-center">
                    <div class="w-8 h-8 rounded-full border-2 border-blue-500 dark:border-blue-400 flex items-center justify-center">
                ...
                <div v-if="file.status === 'error'" class="flex items-center space-x-2">
                  <button @click="retryUpload(index)" class="p-1 text-gray-400 dark:text-[#E2E8F0] hover:text-gray-600 dark:hover:text-gray-400">
